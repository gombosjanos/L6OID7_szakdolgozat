      ...
      >
        ...
        <template #no-data>
          <div class="pa-6 text-medium-emphasis">
            <div>Nincs megjeleníthetõ adat.</div>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" md="3">
              <v-text-field v-model.number="form.afa_kulcs" :disabled="isSzerelo" type="number" step="0.1" label="ÃFA %" variant="outlined" density="comfortable" />
            </v-col>
            <v-col cols="12" md="3">
...
async function save() {
  try{
    if(isSzerelo){
      ...
      if (!payload.a_cikkszam) { setSnack('Cikkszám kötelezõ','error'); return }
